...
This script fills that gap. It loads the anomaly maps saved by a finished run
...
# Folder of the finished run, containing test_stats_{normal,anomalous}.pth
...
def main():
    ...
    np.savez("analysis/out/image_level_scores.npz", y_true=y_true, **scores)
    print("saved pooled scores -> analysis/out/image_level_scores.npz")
